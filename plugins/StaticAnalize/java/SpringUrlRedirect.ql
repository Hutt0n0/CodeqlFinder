...
where sink.getNode() instanceof SpringUrlRedirectSink
select sink.toString(),sink.getNode().getEnclosingCallable(), sink.getNode().getEnclosingCallable().getFile().getAbsolutePath(),  "Potentially untrusted URL redirection"